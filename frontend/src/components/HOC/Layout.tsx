...
const Layout = (Component: any) =>
  function HOC() {
    ...
    return (
      <>
        <nav className=" px-1 bg-gradient-to-r from-gray-700 to-gray-300 flex justify-between fixed w-full items-center mb-2">
        ...
        <div
          ...
          className="flex h-[100vh] min-h-[400px] flex-col items-center justify-center bg-cover bg-fixed md:bg-center bg-[center_left_-10rem]"
        >
          <Component />
        </div>
      </>
